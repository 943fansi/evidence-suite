...
- 机器可审计性（provenance 已生成时）：`audit_provenance.py --claims research_case/provenance/report.claims.json`——R3/R4/N 高危 claim 的支撑证据须带 locator，缺 locator 判 ⛔ 退回补 locator。
